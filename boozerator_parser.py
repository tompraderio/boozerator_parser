        ...
        if header1 == 85: 
            ...
            if header2 == 85: 
                ...
                if frametype == 1: # make sure it's a temp data frame
                    ...
                    # calc checksum
                    check_total = (header1+header2+length+frametype+temp0_upper+temp0_lower+temp1_upper+temp1_lower+temp2_upper+temp2_lower+temp3_upper+temp3_lower+temp4_upper+temp4_lower+temp5_upper+temp5_lower+checksum) & 0xFF
